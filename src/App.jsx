...
function App() {
  ...
  useEffect(() => {
    if (version) {
      localStorage.setItem("RentalHome", version);
    }
  }, [version]);
      ...
      <Provider store={store}>
        <PersistGate loading={null} persistor={persistor}>
          <Routes>
            ...
            <Route path="/add-space" element={<ProtectedRoute><AddSpace /></ProtectedRoute>} />
            <Route path="/add-experience" element={<ProtectedRoute><AddExperience /></ProtectedRoute>} />
            <Route path="/manage-listing" element={<ProtectedRoute><ManageListing /></ProtectedRoute>} />
