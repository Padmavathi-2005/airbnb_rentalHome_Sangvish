...
console.log("guest count",guestCounts.adult)
            ...
            <div className="col-span-4">
              ...
              onClick={(e) => {
                ...
                <div >
                  ...
                  <input
                    type="text"
                    className="outline-none text-sm placeholder-gray-400 w-[100%]"
                    value={`${guestCounts.adult} Adults${guestCounts.children > 0 ? `, ${guestCounts.children} Children` : ''}${guestCounts.infants > 0 ? `, ${guestCounts.infants} Infants` : ''}${guestCounts.pets > 0 ? `, ${guestCounts.pets} Pets` : ''}`}
